...
<section class="product-main" id="product-main">
    <div class="container">
        ...
        <div class="product-main-img-wrapper _anim__items _anim__no__hide">
            ...
            <?php endif; ?>
            <!-- <img src="<? // echo get_template_directory_uri() ?>/img/first-main.png" alt="" class="product-main-img"> -->
        </div>
    </div>
    <div class="product-main-bg-wrapper _anim__items _anim__no__hide">
        <div class="product-main-bg-block">
            <div class="product-main-bg-item product-main-bg-item-stroke-animation" id="product-main-bg-item-stroke-animation">
...
<section class="banner" id="banner-01">
        ...
        <img src="<? echo get_template_directory_uri() ?>/img/banner-mobile.png" class="banner-img banner-img-mobile _anim__items _anim__no__hide">
</section>
<!-- About more -->
...
<section class="banner" id="banner-02">
    <?php $image = get_field('picture_two');
        ...
        <?php endif; ?>
    <img src="<? echo get_template_directory_uri() ?>/img/banner-2-mobile.png" class="banner-img banner-img-mobile _anim__items _anim__no__hide">
</section>
<!-- Form -->
