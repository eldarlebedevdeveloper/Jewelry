...
<section class="marquee-section">
    <div class='marquee-page-about' style='overflow:hidden'><span>The way we work — The way we work — The way we work —
            The way we work — </span></div>
</section>
<!-- Information -->
<section class="about-us-page-information" id="about-us-page-information">
    <div class="container">
        ...
        <img src="<? echo get_template_directory_uri() ?>/img/about-us/about-main-information-bg.png"
            class="about-us-page-information-bg _anim__items _anim__no__hide">
    </div>
</section>
<!-- Marquee -->
...
<section class="about-us-page-information-02" id="about-us-page-information-02">
    <div class="container">
        ...
        <div class="about-us-page-information-bg-wrapper _anim__items _anim__no__hide">
            <img src="<? echo get_template_directory_uri() ?>/img/about-us/about-main-information-bg-02.png"
                class="about-us-page-information-bg-02">
            <img src="<? echo get_template_directory_uri() ?>/img/about-us/about-main-information-bg-02-1.png"
                class="about-us-page-information-bg-02-1">
        </div>
    </div>
</section>
<!-- First screen -->
            ...
            <?php
                ...
                if( $categories ){
                    foreach( $categories as $cat ){
                        $currentCatefory++;
                        ?>
            <a href="#" class="first-screen-nav-item slider_navigation" data-slide="<?php  echo $currentCatefory; ?>"
        ...
        <div class="first-screen-product-wrapper">
            ...
            <div class="first-screen-product-item">
                ...
                <img src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>"
                    onclick="location.href='<?php the_permalink(); ?>'" data-link="<?php the_permalink(); ?>"
    ...
    <div class="first-screen-offer">
        <div class="first-screen-arrow-wrapper">
            <div class="first-screen-arrow-block first-screen-arrow-block-left" id="first-screen-arrow-block-left">
                <a
                    class="first-screen-arrow first-screen-arrow-left first-screen-arrow-left-auto first-screen-arrow-link">
                    <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M5 12.5L19 12.5" stroke="white" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M12 19.7916L19 12.5L12 5.20829" stroke="white" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" />
                    </svg>
                </a>
            </div>
            ...
            <div class="first-screen-arrow-block first-screen-arrow-block-right" id="first-screen-arrow-block-right">
                <a
                    class="first-screen-arrow first-screen-arrow-right first-screen-arrow-right-auto first-screen-arrow-link">
                    <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M5 12.5L19 12.5" stroke="white" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M12 19.7916L19 12.5L12 5.20829" stroke="white" stroke-width="2" stroke-linecap="round"
                        ...
                        <div class="first-screen-catalog-item-top-wrapper">
                            <div class="first-screen-catalog-item-img-wrapper">
                                ...
                                <img src="<?php echo esc_url($image2['url']); ?>"
                                    alt="<?php echo esc_attr($image2['alt']); ?>" class="first-screen-catalog-item-img">
                ...
                <div class="footer-payment-wrapper">
                    ...
                    <div class="footer-payment-block">
                        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="apple-pay"
                            class="svg-inline--fa fa-apple-pay fa-w-20" role="img" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 640 512">
