...
<section class="first-screen first-screen-slider" id="first-screen-slider">
    <div class="container">   
        <div class="first-screen-nav">
                ...
                ?>
                <a href="#" class="first-screen-nav-item slider_navigation" data-slide="all_slides">All  goods(<?php echo $published_posts; ?>)</a>
                <?php
                ...
                if( $categories ){
                    foreach( $categories as $cat ){
                        $currentCatefory++;
                        ?>
                        <a href="#" class="first-screen-nav-item slider_navigation" 
                                    data-slide="<?php  echo $currentCatefory; ?>" 
                                    data-slideCategory='<?php echo $cat->slug; ?>'>
                ...
                ?>
                    <div class="first-screen-product-item">
                        ...
                        <img src="<?php echo esc_url($image['url']); ?>"
                             ...
                             data-slideCategory = "<?php $category = get_the_category(); 
                                                         echo $category[0]->slug; ?>"
                             class="first-screen-product first-screen-product-02">
                     </div>  
                    ...
                    <?php
                        ...
                        ?>
                                <div class="first-screen-catalog-item" 
                                     data-productCategory="<?php $category = get_the_category();echo $category[0]->slug; ?>">
