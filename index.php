...
<body class="body-hidden">
    ...
    <section class="marquee-section">
        <div class='marquee-page-about' style='overflow:hidden'><span>The way we work — The way we work — The way we
                work — The way we work — </span></div>
    </section>
    <!-- Information -->
    ...
    <section class="marquee-section marquee-section-02">
        <div class='marquee-page-about' style='overflow:hidden'><span>History — History — History — History — History —
                History — History — </span></div>
    </section>
    <!-- Information -->
            ...
            <div class="form-section-wrapper">
                ...
                <div class="form-section-offer">
                    ...
                    <form class="form" id="form">
                        ...
                        <div class="form-btn-wrapper"><button type="submit" class="form-btn" id="form-btn">Make an
                                order</button></div>
                    </form>
                </div>
            </div>
