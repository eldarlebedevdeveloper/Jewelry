...
<head>
    ...
    <title><?php 
    // $ishodnaya_str= the_content();
    // $format=str_replace('<p>','',$ishodnaya_str);

    // $ishodnaya_str=the_content();
    // echo $ishodnaya_str."<br />";
    // $format=substr($ishodnaya_str,1,5);
    // echo $format;
    // $ishodnaya_str= get_content();

    // // $content = strip_tags($ishodnaya_str);
    // $str = wp_strip_all_tags( $ishodnaya_str, 0 );
    // echo $str;
