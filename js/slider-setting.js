$(document).ready(function () {
    ...
    $('.first-screen-product-wrapper').on('afterChange', function(event, slick, currentSlide, nextSlide){
        const activeSlide = document.querySelector(`.first-screen-product-item[data-slick-index="${currentSlide}"]`)
    ...
    const activeSlide = document.querySelector(`.first-screen-product-item[data-slick-index="0"]`)
    ...
    function changeLink(slide){
        ...
        // document.querySelectorAll('.make_an_order').forEach(item => {
        //     item.href = link + '#form-section'
        // })
    }
    ...
    function activeCategoryProductsInCatalogProducts(activeCategory){
        ...
        // .first-screen-catalog-item-hide
