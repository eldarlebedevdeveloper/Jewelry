...
<head>
    ...
    <link rel="stylesheet" href="<? echo get_template_directory_uri() ?>/plug/fonts.css">
    <link rel="stylesheet" href="<? echo get_template_directory_uri() ?>/plug/style.css">
    <title>Jewelry</title>
</head>
<body>
    <div class="background_video">
      <video class="video_desctop" preload="auto" no-controls autoplay loop playsinline muted>
            <source src="<? echo get_template_directory_uri() ?>/plug/video/new/BLJ_base264.mp4" type="video/mp4">
            <source src="<? echo get_template_directory_uri() ?>/plug/video/new/BljBase.webm" type="video/webm">
            <source src="<? echo get_template_directory_uri() ?>/plug/video/new/Blj Base264 1.ogv" type="video/ogg">
          </video>
          <video class="video_mobile" preload="auto" no-controls autoplay loop playsinline muted>
            <source src="<? echo get_template_directory_uri() ?>/plug/video/new/videomobile.mp4" type="video/mp4">
            <source src="<? echo get_template_directory_uri() ?>/plug/video/new/videomobile.webm" type="video/webm">
            <source src="<? echo get_template_directory_uri() ?>/plug/video/new/videomobile.ogv" type="video/ogg">
          </video> 
    ...
    <div class="content">
        ...
        <div class="content_main">
            <div class="content_main-item">
                <h5>Coming soon</h5>
                <h5 class="content_under_text">Our Passion about Jewelry</h5>
            </div>
            <div class="content_main-item">
                <h4>Coming soon</h4>
                <h4 class="content_under_text">Our Passion about Jewelry</h4>
            </div>
            <div class="content_main-item">
                <h3>Coming soon</h3>
                <h3 class="content_under_text">Our Passion about Jewelry</h3>
            </div>
            <div class="content_main-item">
                <h2>Coming soon</h2>
                <h2 class="content_under_text">Our Passion about Jewelry</h2>
            </div>
            <div class="content_main-item">
                <h1>Coming soon</h1>
                <h1 class="content_under_text">Our Passion about Jewelry</h1>
            </div>
        </div>
        
        <div class="content_footer">
            <div class="social">
                <a href="https://www.instagram.com/bezlikiy/">
    ...
    <script src="<? echo get_template_directory_uri() ?>/plug/test.js"></script>
</body>
</html>